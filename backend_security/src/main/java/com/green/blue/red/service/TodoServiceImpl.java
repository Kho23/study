...
public class TodoServiceImpl implements TodoService {
    ...
    public void modify(TodoDto dto) {
        log.info("controller 에서 넘어온 dto {}",dto);
        Todo todo  = repository.findById(dto.getTno()).get();
        Todo modifiedTodo = todo.builder()
                .title(dto.getTitle())
                ...
                .build();
        log.info("저장 후 entity : {}",modifiedTodo);
        // 리액트로부터 입력된 dto 를 entity 로 저장 후 DB 에 저장
